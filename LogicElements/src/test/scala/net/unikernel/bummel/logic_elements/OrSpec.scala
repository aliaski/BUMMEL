...
class OrSpec extends FlatSpec with ShouldMatchers with BeforeAndAfter {
 ...
 var or: Or = _
  ...
  "Or element" should "return 0 for 000 input" in {
   val valuesOnPorts = new Signals {
    ...
    val result = or.process(valuesOnPorts).asScala
  ...
  it should "return 1 for 010 input" in {
    val valuesOnPorts = new Signals {
      put("input1", 0)
      put("input2", 1)
      put("output", 0)
  ...
  it should "return 1 for 011 input" in {
    val valuesOnPorts = new Signals {
      put("input1", 0)
      put("input2", 1)
      put("output", 1)
  ...
  it should "return 1 for 100 input" in {
    val valuesOnPorts = new Signals {
      put("input1", 1)
      put("input2", 0)
      put("output", 0)
  ...
  it should "return 1 for 101 input" in {
    val valuesOnPorts = new Signals {
      put("input1", 1)
      put("input2", 0)
      put("output", 1)
